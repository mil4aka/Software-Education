function sumOfTwoNumbers(input) {
    ...
    let magicNumberFound = false; // suzdavame si buleva promenliva
    ...
    for (let i = intervalStart; i <= intervalEnd; i++) {
        for (let j = intervalStart; j <= intervalEnd; j++) {
            ...
            if (i + j === magicNumber) {
                ...
                break; //break-vame vlojeniq cikul
            }
        }
        if (magicNumberFound == true) { // pravim sushtata proverka za da break-nem i osnovniq cikul
            break;
        }
    } 
