function onTimeForTheExam(input) {
    ...
    let beingOnTime = (timeOfArrivalIntoMinutes - examTimeIntoMinutes == 0 ||
        examTimeIntoMinutes - timeOfArrivalIntoMinutes <= 30); // if he's early up to 30 mins

    let beingEarly = (timeOfArrivalIntoMinutes - examTimeIntoMinutes < 30); // if he's early > 30 mins
